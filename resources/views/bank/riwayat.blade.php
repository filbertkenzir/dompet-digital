        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                    ...
                    <li>
                        <a href="{{ url('bank/akun') }}" class="block py-2 px-3 md:p-0 text-gray-900 rounded-sm md:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700">Kelola Akun</a>
                    </li>
                    <li>
                        <a href="{{ url('bank/riwayat') }}" class="block py-2 px-3 md:p-0 text-white bg-green-700 rounded-sm md:bg-transparent md:text-green-700" aria-current="page">Riwayat</a>
                    </li>
                </ul>
            </div>
        </div>
